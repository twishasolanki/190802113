...
<div class="w3layouts-main">
	<h2>Sign In Now</h2>
        ...
        <asp:TextBox ID="TextBox1" runat="server" type="text" class="ggg" name="Email" placeholder="E-MAIL" required=""></asp:TextBox>
			
        <asp:TextBox ID="TextBox2" runat="server" type="password" class="ggg" name="Password" placeholder="PASSWORD" required=""></asp:TextBox>
